    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" method= "POST" action="{{route('value')}}"  enctype="multipart/form-data">
                        @csrf
                        <div class="control-group">
                            <div class="inc">
                                <div class="controls">
                                    <button style="margin-left: 50px" class="btn btn-info" type="submit" id="append" name="append">新增文字訊息</button>
                                    <button style="margin-left: 50px" class="btn btn-info" type="submit" id="image" name="image">新增圖片或影片訊息</button>
                                    <br>
                                    <br>
                                </div>
                            </div>
